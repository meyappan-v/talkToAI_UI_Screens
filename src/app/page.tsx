...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    document.addEventListener("mousemove", resetOnUserActivity);
    document.addEventListener("keydown", resetOnUserActivity);

    // Clean up event listeners when the component unmounts
    return () => {
      document.removeEventListener("mousemove", resetOnUserActivity);
      document.removeEventListener("keydown", resetOnUserActivity);
    };
  }, []);

  return (
    <div className={`container w-[100%] ${addClass ? "box" : ""}`}>
